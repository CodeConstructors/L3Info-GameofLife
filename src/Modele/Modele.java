...
/**
 * Modele est la classe qui gere les calculs sur le jeu Cette classe est
 * caractérisée par les informations suivantes :
 * <ul>
 * <li>Solitude est le nombre de cellules voisine en dessous du quel la cellule
 * deperit</li>
 * <li>asphyxie est le nombre de cellules voisine au dessus du quel la celule
 * deperit</li>
 * <li>minVie est le nombre de cellule voisine necessaire à l'apparition d'une
 * nouvelle celule</li>
 * <li>maxVie est le nombre de cellule voisine necessaire à l'apparition d'une
 * nouvelle celule</li>
 * </ul>
...
public class Modele {
    ...
    /**
     * <b>Fonction jeu </b>
     * Calcul la possition du plateau à l'intant t+1 /!\ ne modifie pas le
     * tableau du modele
     *
        ...
        for (int i = 0; i < this.largeur; i++) {
            for (int j = 0; j < this.hauteur; j++) {
                ...
                if (nbVoisins <= solitude || nbVoisins >= asphyxie) {
                    local_tab[i][j] = false;
                } else if (nbVoisins >= this.minVie && nbVoisins <= this.maxVie) {
                    local_tab[i][j] = true;
                } else {
     ...
     * Fonction qui redefini la taille du tableau sans perte de donnée Les
     * vérifications seront effectuer dans le controleur
     */
