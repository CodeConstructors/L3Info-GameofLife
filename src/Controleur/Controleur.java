...
public class Controleur {
    ...
    /**
     * Constructeur par default du Controleur, il crée la vue et le modele et
     * les initialise
     */
    public Controleur() {
        this.m = new Modele();
    ...
    /**
     * catchClick Methode qui traite les click sur un des panel
     *
    ...
    /**
     * CatchClickDroit Reçoit l'information lors d'un click droit
     *
     * @param p : Le point sur lequel l'utilisateur a cliquer
     * @param panel : Le panel sur lequel l'utilisateur a cliqué
     * @param mod : Le modifieur renvoyer par l'evenement mouseListener lors
     * d'un click
     */
    ...
    /**
     * Modifie les tableaux à partir de ce que le modele calcul pour le prochain
     * mouvement
     */
    ...
    public synchronized void playpause() {
        ...
        } else //Met le thread en pause, si il y est deja, le relance
        {
     ...
     *
     * Change la taille du tableau, verifie la validité des parametre
     *
     * @param larg Nouvelle largeur
     * @param haut Nouvelle hauteur
     */
     ...
     * Crée un tableau remplit de cellule placé aléatoirement La taille du
     * tableau est basé sur celle du panel actif
     *
     ...
     * Met le jeu en pause si necessaire et remplit le tableau de cellule
     *
     ...
     * Copie le contenu du tableau donner dans le mini tableau Utilise un clone
     * et pas une copie de reference pour eviter d'alterer le tableau initial
     * (dans le contexte du programme le patern) Redefini egalement le tableau
     * de panel_tampon
     *
     * @param tab : tableau à copier
     */
