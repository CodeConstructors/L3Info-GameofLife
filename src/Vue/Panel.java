...
/**
 * Panel est la vue qui affiche l'etat en cour du jeu de la vie Cette classe est
...
public class Panel extends JPanel implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    /**
     * Definit si la taille des cellules est fixe, ou si elle depend de la
     * taille du panel
     */
     ...
     * Definit le tableau de cellule utiliser, appelle la redefinition du panel
     * et le rapaint modifie les attributs de taille On ne verifie pas les
     * valeurs du nouveau tableau, ce sera gerer à l'appelle
     *
     ...
     *
     * Si les cellules sont en taille fixe change la taille du panel Si les
     * cellules sont en taille relative change la taille des cellules
     *
     */
    private void resize() {
     ...
     * Detecte un clique et recupere ses coordonnée dans le tableau (convertit
     * la position relative au panel en position relative au tableau de cellule
     * ) Appelle la methode correspondant au bouton de la souris cliquer au
     * controleur
     */
    @Override
